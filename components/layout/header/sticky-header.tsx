...
export function StickyHeader({ visible = false, className }: StickyHeaderProps) {
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 border-b border-surface-gray/25 bg-surface-white/98 text-surface-dark shadow-sm backdrop-blur-md transition-transform duration-300 ${
