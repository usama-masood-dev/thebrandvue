...
type SocialLink = (typeof footerContent.socialLinks)[number];
      ...
      {links.map((link) => (
        <li key={link.id}>
          <a
            ...
            className="flex size-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/80 transition-colors hover:border-accent/50 hover:bg-accent/10 hover:text-accent"
          >
